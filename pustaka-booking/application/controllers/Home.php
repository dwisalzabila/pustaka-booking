...
class Home extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->session->userdata('email')) {
            ...
            $data['user'] = $user['nama'];
            $this->load->view('template/templates-user/header', $data);
            $this->load->view('buku/daftar_buku', $data);
            $this->load->view('template/templates-user/modal');
            $this->load->view('template/templates-user/footer', $data);
        } else {
    ...
    public function detailBuku()
    {
        ...
        $this->load->view('template/templates-user/modal');
        $this->load->view('template/templates-user/footer');
    }
}
